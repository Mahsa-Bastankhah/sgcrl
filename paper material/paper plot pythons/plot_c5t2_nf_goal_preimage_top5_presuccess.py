#!/usr/bin/env python3
"""Exact top-5 NF goal-preimage samples with a 3-step post-success grace.

Rows 200–650 use the 40M checkpoint-every-10 seed-0 run. Rows 800 and
1200 use the 200M paper seed-2 run. Each cell identifies the rollout and
macro-step from which the selected (s, a) sample came.
"""
...
_CKPT10 = os.path.join(
    ...
    "creative5_task2_nf_nopermute_fixedx01_goal_preimage_post3_ckpt10_front",
)
_S2 = os.path.join(
    _REPO, "figs", "builderbench",
    "creative5_task2_nf_nopermute_fixedx01_goal_preimage_post3_s2_front",
)
OUT_STEM = os.path.join(
    _PAPER, "paper plots", "bb_c5t2_nf_goal_preimage_top5_presuccess")
